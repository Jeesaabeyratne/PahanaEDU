...
<div class="main">
    ...
    <div class="dashboard">
        ...
        <a href="update-book.jsp" class="card"><i class="fa fa-pen-to-square"></i><br>Update Book</a>
        <a href="create-bill.jsp" class="card"><i class="fa fa-file-invoice-dollar"></i><br>Create Bill</a>
        <a href="view-bill.jsp" class="card"><i class="fa fa-receipt"></i><br>View Bill</a>
